...
> [!TIP]
> **Нужна помощь со скриншотами?** > Читайте [Подробную инструкцию в Google Docs](https://docs.google.com/document/d/1el7PHDrcuiUuotty4Jitg0vWCkUWQjIVKL2kKO1mKx8/edit?tab=t.0) — там есть описание каждого шага и пояснения к настройкам.

---

### 📋 Ссылки для импорта
*Нажмите на иконку копирования (📋) в углу блока со ссылкой:*
